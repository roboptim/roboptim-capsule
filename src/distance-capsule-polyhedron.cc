...
/**
 * \file src/distance-capsule-polyhedron.cc
 *
 * \brief Implementation of DistanceCapsulePolyhedron.
 */

#ifndef ROBOPTIM_CAPSULE_DISTANCE_CAPSULE_POLYHEDRON_CC_
# define ROBOPTIM_CAPSULE_DISTANCE_CAPSULE_POLYHEDRON_CC_
...
namespace roboptim
{
  namespace capsule
  {
    ...
    DistanceCapsulePolyhedron::
    DistanceCapsulePolyhedron (std::string name) throw ()
      : roboptim::Function (7, 1, name),
	segment_ (),
	polyhedron_ (),
	analysis_ ()
    ...
    const polyhedron_t DistanceCapsulePolyhedron::
    polyhedron () const throw ()
    {
      return polyhedron_;
    }

    void DistanceCapsulePolyhedron::
...
#endif //! ROBOPTIM_CAPSULE_DISTANCE_CAPSULE_POLYHEDRON_CC_
